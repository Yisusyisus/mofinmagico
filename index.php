...
<head>
  ...
  <script
    src="//apps.8thwall.com/xrweb?appKey=t5oYRNoUe41N9FY2cn5c3QUgxWYzXzEA8SyPvQUp6hPMoo4msnuv9xv0dI4L344i6kBqmb"></script>
...
<body>
  ...
  <a-scene
    ...
    <a-assets>
      <a-asset-item id="frame-glb" src="mofin.glb"></a-asset-item>
    </a-assets>
    ...
    <a-entity image-target>
      ...
      <a-entity id="frame"  position="1 -1 -3"  scale=".5 .5 .5" rotation="0 40 0" gltf-model="#frame-glb"></a-entity>
